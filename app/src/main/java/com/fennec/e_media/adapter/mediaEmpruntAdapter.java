...
public class mediaEmpruntAdapter extends RecyclerView.Adapter<mediaEmpruntAdapter.MyViewHolder> {
    ...
    public mediaEmpruntAdapter(List<media> list)
    {
        this.list = list;
    }

    @Override
    public mediaEmpruntAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_admin, parent, false);

        return new mediaEmpruntAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final mediaEmpruntAdapter.MyViewHolder holder, final int position)
    {
